...
const ListCard = ({ item }) => {
  ...
  const statusBadge = () => {
    ...
    const badgeColor = hasSurpassedTime() ? (
      <span
        className={`position-absolute translate-middle top-0 start-50 p-2 badge bg-danger fs-6`}
      >
        {" "}
        Finished{" "}
      </span>
      ...
      <span
        className={`position-absolute translate-middle top-0 start-50 p-2 badge bg-success fs-6`}
      >
        {" "}
        Ongoing{" "}
      </span>
      ...
      <span
        className={`position-absolute translate-middle top-0 start-50 p-2 badge bg-warning fs-6`}
      >
        {" "}
        Upcoming{" "}
      </span>
    ...
    <>
      <Card style={{ width: "22rem", height: "38rem" }}>
        ...
        <Card.Body className="text-center">
          <a
            href={`/AuctionPage/${item._id}`}
            className="btn btn-primary w-100 position-absolute start-0 bottom-0"
          >
            View
          </a>
        </Card.Body>
